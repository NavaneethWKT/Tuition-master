...
export function ParentClassNotes() {
  ...
  // Fetch student ID first, then materials
  useEffect(() => {
    if (userData?.id) {
      fetchStudentId();
    }
  ...
  return (
    <div className="min-h-screen bg-paper">
      <PageHeader
        ...
        subtitle="View study materials uploaded by teachers"
        showBackButton={true}
        ...
        <Card className="shadow-lg border-0 bg-gradient-to-br from-blue-500 to-blue-600 text-white">
          <CardContent className="py-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-white mb-2">Class Materials</h3>
                <p className="text-blue-100 mb-4">
                  View all study materials uploaded by teachers
                </p>
                        ...
                        onClick={async () => {
                          if (note.public_id) {
                            try {
                              ...
                              const cleanUrl = resp.url?.endsWith("?")
                                ? resp.url.slice(0, -1)
                                : resp.url;
                              setPdfViewer({
                                open: true,
